...
import { db, chai, app, expect, handleError } from '../../test-utils';
				...
				it('should create a new Post', () => {
					...
					return chai.request(app)
						...
						.then(res => {
							...
							expect(createdPost.content).to.equals('Fourth content');
				...
				it('should update an existing Post', () => {
					...
					return chai.request(app)
						...
						.then(res => {
							...
							expect(updatedPost.title).to.equals('Post changed');
							expect(updatedPost.content).to.equals('Content changed');
